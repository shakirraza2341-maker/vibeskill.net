...
async function POST(request) {
    try {
        ...
        // Validation
        const { title, description, required, minimum_salary, maximum_salary, country, city, location, remote_available, skills } = body;
        const errors = {};
        if (!title?.trim()) errors.title = "Title is required";
        if (!description?.trim()) errors.description = "Description is required";
        if (!required || required < 1) errors.required = "Required positions must be at least 1";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__310651a5._.js.map