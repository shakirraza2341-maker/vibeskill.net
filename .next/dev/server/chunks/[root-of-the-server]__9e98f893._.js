...
"[project]/app/api/jobs/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, { params }) {
    try {
        const job = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jobs$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findJob"])((await params).id);
        return job ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            job
...
async function PUT(request, { params }) {
    try {
        ...
        const job = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jobs$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateJob"])(id, {
...
async function DELETE(_request, { params }) {
    try {
        const deleted = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jobs$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteJob"])((await params).id);
        return deleted ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9e98f893._.js.map