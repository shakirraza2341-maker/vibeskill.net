...
async function GET() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        users: await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$users$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listUsers"])()
    });
}
async function PATCH(request) {
    ...
    try {
        ...
        const role = [
            ...
            "user",
            "employer"
        ].includes(body.role) ? body.role : undefined;
        const employerStatus = [
            "none",
            "pending",
            "approved",
            "rejected"
        ].includes(body.employer_status) ? body.employer_status : undefined;
        const status = body.status === "approved" || body.status === "rejected" ? body.status : undefined;
        if (!role && !employerStatus && !status) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Invalid user update"
        }, {
            status: 400
        });
        const user = status ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$users$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reviewEmployerApplication"])(userId, status, guard.session.user.id) : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$users$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateUserAdmin"])(userId, {
            role,
            employer_status: employerStatus
        });
        return user ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            user
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fef1ca69._.js.map