...
async function GET() {
    const guard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$guard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireUser"])();
    if (guard.response) return guard.response;
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$users$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findUserById"])(guard.session.user.id);
...
async function PUT(request) {
    ...
    try {
        ...
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$users$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateUserProfile"])(guard.session.user.id, {
            name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4818fc11._.js.map