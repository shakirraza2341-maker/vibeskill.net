...
"[project]/app/api/resume/generate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    if (isFileUpload) {
        ...
        if (!(uploadedFile instanceof File)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    if (!file && (!hasResumeText && !body?.targetRole?.trim() || !hasResumeText && (!body?.profile?.name?.trim() || !body?.profile?.email?.trim()))) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "A target role and resume content are required"
    }, {
        status: 400
    });
    const prompt = file ? [
    ...
    try {
        ...
        if (!response.ok) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Gemini could not build this resume"
            }, {
                status: 502
            });
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Unable to build this resume right now"
        }, {
            status: 502
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c974aedd._.js.map